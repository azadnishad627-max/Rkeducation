...
export default function Interactive3DLab() {
  ...
  const modelsList = [
    {
      ...
      parts: [
        { name: '1. भूपर्पटी (Crust / सियाल)', detail: 'सबसे ऊपरी पतली परत (35 किमी महाद्वीप, 5 किमी महासागर)। सिलिका व एलुमिना से निर्मित।' },
    ...
    },
    {
      ...
      parts: [
        { name: '1. सूर्य (The Sun)', detail: 'सौरमंडल का केंद्र एवं ऊर्जा/प्रकाश का एकमात्र स्रोत (तापमान 6000°C)।' },
        { name: '2. आंतरिक ग्रह (बुध, शुक्र, पृथ्वी, मंगल)', detail: 'चट्टानी ग्रह। शुक्र सबसे गर्म व चमकीला, पृथ्वी नीला ग्रह।' },
        { name: '3. बाह्य गैसीय ग्रह (बृहस्पति, शनि, यूरेनस, नेप्च्यून)', detail: 'बृहस्पति सबसे बड़ा ग्रह, शनि के चारों ओर बर्फ व धूल के वलय (Rings)।' }
      ]
    },
    {
      id: 'cell',
      ...
      parts: [
        { name: '1. केंद्रक (Nucleus)', detail: 'कोशिका का नियंत्रण केंद्र जिसमें गुणसूत्र (DNA व जीन) होते हैं।' },
        { name: '2. माइटोकॉन्ड्रिया (Mitochondria)', detail: 'कोशिका का पावरहाउस (ऊर्जा गृह) जहाँ ATP के रूप में ऊर्जा बनती है।' },
        { name: '3. कोशिका झिल्ली व द्रव्य (Cytoplasm)', detail: 'कोशिका को आकार देने वाली एवं पोषक तत्वों का आदान-प्रदान करने वाली परत।' }
      ]
    },
    {
      id: 'atom',
      ...
      parts: [
        { name: '1. नाभिक (Nucleus)', detail: 'धनावेशित प्रोटॉन और उदासीन न्यूट्रॉन से बना केंद्रीय भारी भाग।' },
        { name: '2. इलेक्ट्रॉन कक्षाएं (Orbits)', detail: 'नाभिक के चारों ओर निश्चित ऊर्जा स्तरों पर चक्कर लगाते ऋणावेशित इलेक्ट्रॉन।' },
        { name: '3. ऊर्जा स्पेक्ट्रम', detail: 'इलेक्ट्रॉनों के कक्षा परिवर्तन से प्रकाश व विकिरण ऊर्जा का उत्सर्जन।' }
      ]
    },
    {
      id: 'volcano',
      ...
      subject: 'भूगोल (Geography)',
      desc: 'मैग्मा चेंबर, वेंट पाइप, क्रेटर और लावा उद्गार का 3D दृश्य',
      parts: [
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // Model specific micro-animations
      if (activeModel === 'atom') {
  ...
  // Function to build geometric 3D models with labels
  function build3DModel(type, group) {
    ...
    if (type === 'earth') {
      ...
      const crustMat = new THREE.MeshStandardMaterial({ color: 0x0284c7, roughness: 0.3, metalness: 0.2, wireframe: false });
      ...
      // Mitochondria (Powerhouse) Organelles
      for (let i = 0; i < 4; i++) {
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-lg sm:text-xl font-extrabold font-display text-white">
              3D इंटरैक्टिव साइंस एवं जियोग्राफी डायग्राम लैब (3D Visual Lab)
            </h3>
            <p className="text-xs text-slate-400 font-mono">
              माउस या टच से 360° घुमाएं, ज़ूम करें और हिंदी में प्रत्येक अंग को समझें
            </p>
          </div>
        </div>
